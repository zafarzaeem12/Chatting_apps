...
const Create_New_Messages = async (req,res,next) => {
    const attachments = req?.files?.chat_attachment?.map((data) => data?.path?.replace(/\\/g, "/"))
    try{
        const messages = {
